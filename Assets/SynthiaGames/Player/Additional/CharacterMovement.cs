...
namespace EasyCharacterMovement
{
    ...
    public sealed class CharacterMovement : MonoBehaviour
    {
        ...
        [Space(15f)] [SerializeField, Tooltip("The root transform in the avatar.")]
        ...
        [Space(15f)] [Tooltip("The maximum angle (in degrees) for a walkable surface.")] [SerializeField]
        ...
        [Space(15f)] [Tooltip("Character collision layers mask.")] [SerializeField]
        ...
        [Space(15f)] [SerializeField] private Advanced _advanced;
            ...
            float acceleration, float deceleration, float friction, float brakingFriction, float deltaTime)
        {
            ...
            {
                float newMaxSpeed = currentVelocity.isExceeding(actualMaxSpeed)
...
#if UNITY_EDITOR
            if (_capsuleCollider == null)
                TryGetComponent<CapsuleCollider>(out _capsuleCollider);
#endif
            if (_capsuleCollider)
            {
            ...
            int sweepLayerMask, out RaycastHit hitResult, out bool startPenetrating)
        {
            ...
            bool innerCapsuleHit =
                CapsuleCast(sweepOrigin, sweepRadius, sweepDirection, sweepDistance + sweepRadius, sweepLayerMask,
                    out RaycastHit innerCapsuleHitResult, out startPenetrating) &&
            ...
            bool outerCapsuleHit =
                CapsuleCast(sweepOrigin, outerCapsuleRadius, sweepDirection, sweepDistance + outerCapsuleRadius,
                    sweepLayerMask, out RaycastHit outerCapsuleHitResult, out _) &&
            ...
            out float recoverDistance, bool ignoreBlockingOverlaps = false)
        {
            ...
            bool innerCapsuleHit =
                CapsuleCastEx(sweepOrigin, sweepRadius, sweepDirection, sweepDistance + sweepRadius, sweepLayerMask,
                    out RaycastHit innerCapsuleHitResult, out startPenetrating, out recoverDirection,
        ...
        private bool ResolvePenetration(Vector3 displacement, Vector3 proposedAdjustment)
        {
            ...
            else
            {
                ...
                bool hit = CapsuleCastEx(updatedPosition, _radius, adjustment.normalized, adjustment.magnitude,
                    _collisionLayers,
                    out RaycastHit sweepHitResult, out bool startPenetrating, out Vector3 recoverDirection,
        ...
        private void MoveAndSlide(Vector3 displacement)
        {
            ...
            {
                bool collided = MovementSweepTest(updatedPosition, default, displacement,
                    out CollisionResult collisionResult);
                if (!collided)
                    break;
        ...
        private void UpdatePlatformMovement(float deltaTime)
        {
            ...
            else
            {
                ...
                if (impartPlatformRotation)
                {
                    ...
                    {
                        Vector3 activePlatformAngularVelocity = deltaTime > 0.0f
                            ? deltaRotation.eulerAngles * Mathf.Deg2Rad / deltaTime
                            : Vector3.zero;
                        Quaternion yawRotation =
                            Quaternion.Euler(Vector3.Project(activePlatformAngularVelocity, _characterUp) *
        ...
        private void ResolveDynamicCollisions()
        {
            ...
            for (int i = 0; i < _collisionCount; i++)
            {
                ...
                ComputeDynamicCollisionResponse(ref collisionResult, out Vector3 characterImpulse,
                    out Vector3 otherImpulse);
